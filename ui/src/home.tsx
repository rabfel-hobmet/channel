...
export function Home() {
    ...
    return (
        <main className="flex flex-col items-center justify-center min-h-screen px-4 space-y-4 lg:space-y-0">
            <Marquee gradient={false} className="static lg:absolute min-w-screen top-4 -right-8 lg:rotate-12 border-b-4 bg-black border-black" speed={200}>
        ...
        <div className="w-full max-w-prose border rounded-xl p-2 py-16 my-16 bg-ridge-yellow border-black z-10">
